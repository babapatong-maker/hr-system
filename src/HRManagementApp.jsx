...
function speakThai(text) {
  try {
    ...
    const spokenText = String(text || "").replace(/[^\p{L}\p{N}\p{P}\p{Zs}]/gu, "").trim();
...
const QUOTES = {
  early: [
    "สุดยอดมากครับคุณครู มาเช้าขนาดนี้พลังเต็มร้อยแน่นอน",
    "ครูตัวอย่างของจริงครับ เริ่มวันได้สวยมาก",
    "มาเร็วแบบนี้ เด็ก ๆ ได้พลังดี ๆ ตั้งแต่เช้าเลยครับ",
    "วินัยเยี่ยมมากครับ วันนี้ต้องเป็นวันที่ดีแน่นอน",
    "ขอปรบมือให้เลยครับคุณครู พร้อมลุยสุด ๆ",
    "เริ่มวันอย่างมืออาชีพมากครับ ไฟต์ติ้งนะครับ",
    "เช้านี้คุณครูมาอย่างแกร่ง ขอให้สอนสนุกทั้งวันครับ",
    "พลังครูเต็มมากครับ วันนี้ลุยได้ยาว ๆ เลย",
    "มาเช้าขนาดนี้ โรงเรียนได้กำลังใจตั้งแต่เปิดวันครับ",
  ],
  onTime: [
    "ตรงเวลาเป๊ะครับคุณครู วันนี้ลุยไปด้วยกันนะครับ",
    "เริ่มงานสวยมากครับ ขอให้วันนี้ราบรื่นทั้งวัน",
    "พร้อมแล้วครับคุณครู ไฟต์ติ้งสำหรับวันใหม่",
    "วันนี้ต้องเป็นวันที่ดีแน่นอนครับ สู้ ๆ นะครับ",
    "ขอบคุณที่เริ่มวันอย่างมืออาชีพครับ ลุยกันเลย",
    "ขอให้วันนี้เจอแต่เรื่องดี ๆ และเด็ก ๆ น่ารักนะครับ",
    "พร้อมสอน พร้อมลุย พร้อมยิ้มครับคุณครู",
    "เริ่มตรงเวลาแบบนี้ งานวันนี้ไปได้สวยแน่นอนครับ",
  ],
  late: [
    "ไม่เป็นไรครับคุณครู เริ่มตอนนี้ก็ยังสู้ได้เต็มที่",
    "มาถึงแล้วครับ หายใจลึก ๆ แล้วลุยวันใหม่ไปด้วยกัน",
    "วันนี้อาจเริ่มช้า แต่งานดี ๆ ยังเริ่มได้เสมอครับ",
    "ไม่ต้องกดดันนะครับ ตั้งหลักแล้วไปต่อ คุณครูทำได้",
    "มาสายได้นิดหน่อย แต่ใจสู้ต้องมาเต็มครับ",
    "เข้าใจครับ ทุกวันมีจังหวะของมัน วันนี้ยังแก้เกมได้",
    "ขอให้ช่วงที่เหลือของวันดีขึ้นเรื่อย ๆ นะครับ สู้ ๆ",
    "พร้อมแล้วเดินหน้าต่อครับ เด็ก ๆ รอพลังดี ๆ จากคุณครูอยู่",
    "เริ่มช้าไม่เป็นไร ขอให้วันนี้จบสวยครับคุณครู",
  ],
  leaveEarly: [
    "ขอบคุณคุณครูที่ดูแลเด็ก ๆ วันนี้นะครับ",
    "ขอบคุณสำหรับแรงใจที่มอบให้โรงเรียนวันนี้ครับ",
    "วันนี้คุณครูเหนื่อยมามากแล้ว เดินทางปลอดภัยนะครับ",
    "ขอบคุณที่อยู่เคียงข้างเด็ก ๆ ในทุกชั่วโมงเรียนครับ",
    "โรงเรียนขอบคุณคุณครูจากใจ ขอให้ช่วงเย็นได้พักเต็มที่ครับ",
    "ขอบคุณคุณครูสำหรับความตั้งใจของวันนี้ครับ",
    "ขอให้ภารกิจหลังเลิกงานราบรื่นนะครับ ขอบคุณคุณครูมากครับ",
  ],
  stayLate: [
    "ขอบคุณคุณครูที่ทุ่มเทจนเกินเวลา โรงเรียนซาบซึ้งมากครับ",
    "วันนี้เหนื่อยมาทั้งวันแล้ว ขอบคุณที่ดูแลเด็ก ๆ อย่างเต็มที่ครับ",
    "ขอบคุณคุณครูที่เสียสละเวลาเพื่อโรงเรียนและนักเรียนครับ",
    "ความตั้งใจของคุณครูมีค่ามาก ขอบคุณจากใจครับ",
    "ขอบคุณที่อยู่ดูแลงานจนเรียบร้อย ขอให้ได้พักอย่างสบายใจครับ",
    "โรงเรียนเห็นความทุ่มเทของคุณครูนะครับ ขอบคุณมากครับ",
    "วันนี้คุณครูทำเต็มที่แล้ว ขอบคุณและเดินทางปลอดภัยครับ",
    "ขอบคุณคุณครูที่เป็นกำลังสำคัญของโรงเรียนครับ",
  ],
  onTimeLeave: [
    "ขอบคุณคุณครูที่เหนื่อยมาทั้งวันครับ ขอให้พักผ่อนเต็มที่นะครับ",
    "โรงเรียนขอบคุณคุณครูสำหรับวันนี้ครับ เดินทางกลับบ้านปลอดภัยนะครับ",
    "ขอบคุณที่ดูแลเด็ก ๆ ตลอดทั้งวันครับ เจอกันพรุ่งนี้นะครับ",
    "วันนี้คุณครูทำเต็มที่แล้ว ขอบคุณมากครับ ขอให้เย็นนี้เป็นเวลาที่ดีครับ",
    "ขอบคุณคุณครูจากใจครับ พักให้หายเหนื่อยนะครับ",
    "ขอบคุณสำหรับความตั้งใจของวันนี้ โรงเรียนภูมิใจในคุณครูครับ",
    "ภารกิจวันนี้เรียบร้อยแล้ว ขอบคุณคุณครูมากครับ เดินทางปลอดภัยครับ",
  ]
};
