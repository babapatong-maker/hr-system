                      ...
                      <tbody>
                        {activityLog.map((row, i) => (
                          <tr key={row.id} style={{ borderBottom: "1px solid #f8fafc", background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                            ...
                            <td style={{ padding: "0.65rem 0.75rem", color: "#475569", fontWeight: 600, whiteSpace: "nowrap" }}>{new Date(new Date(row.check_in).getTime() + 7*60*60*1000).toLocaleTimeString("th-TH", { hour: "2-digit", minute: "2-digit", timeZone: "Asia/Bangkok" })} น.</td>
                            <td style={{ padding: "0.65rem 0.75rem" }}>
